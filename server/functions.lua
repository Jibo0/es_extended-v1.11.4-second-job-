...
function ESX.RefreshJobs()
    ...
    for _, v in ipairs(jobGrades) do
        --print("Loading grade for job:", v.job_name, "Grade:", v.grade)
    ...
    if not Jobs then
        ...
        ESX.Jobs = Jobs
        --print("Jobs loaded:", json.encode(ESX.Jobs))
    end
end
...
---@param grade2 string
---@return boolean
function ESX.DoesJobExist(job, grade, job2, grade2)
    grade = tostring(grade)
    grade2 = tostring(grade2)

    print("Checking job:", job)
    print("Checking grade:", grade)
   -- print("Available jobs:", json.encode(ESX.Jobs))
